    ...
    return (
        <PageLayout id="about" title="Sobre mim">
            <AnimatedSection id="motionAbout">
                <Box height="20em" width={{xs: "90vw", sm: "35em", md: "45em"}} display="flex" alignItems="center">
                    <Typography variant="body1" textAlign="justify" fontSize={{xs: "small", sm: "medium", md: "large"}}>
